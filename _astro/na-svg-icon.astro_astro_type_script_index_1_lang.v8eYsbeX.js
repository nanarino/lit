import{i as h,a as l,x as k}from"./lit-element.Befuxl2y.js";import{n as d,t as u}from"./property.SQfKehJm.js";import{n as H}from"./query-assigned-nodes.DReJme1H.js";import"./base.CShCMygk.js";const V=`<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="rgb(var(--pinkpurple-6, 217 26 217))" stroke-width="4">\r
...
<path d="M38 38H42V42H38V38Z" stroke-linecap="butt"></path>\r
</svg>`;var c=Object.defineProperty,b=Object.getOwnPropertyDescriptor,i=(t,n,o,p)=>{for(var r=p>1?void 0:p?b(n,o):n,a=t.length-1,s;a>=0;a--)(s=t[a])&&(r=(p?s(n,o,r):s(r))||r);return p&&r&&c(n,o,r),r};let e=class extends l{constructor(){super(...arguments),this.src=""}async load(){if(this.src)try{const t=await fetch(this.src);if(!t.ok)throw new Error(`${t.status}`);this.shadowRoot.innerHTML=await t.text()}catch(t){this.renderRoot.dispatchEvent(new CustomEvent("load-error",{bubbles:!0,composed:!0,detail:t,cancelable:!0}))&&(this.shadowRoot.innerHTML=V)}}updated(t){t.has("src")&&this.load(),super.updated(t)}render(){return k`<slot></slot>`}};e.styles=h`
        :host {
            display: inline-flex;
            width: 1em;
            height: 1em;
    ...
    `;i([H()],e.prototype,"defaultSlotNodes",2);i([d({type:String})],e.prototype,"src",2);e=i([u("na-svg-icon")],e);
