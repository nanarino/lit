import{N as g}from"./base.DRq99R0c.js";import{x as c,i as h}from"./lit-element.Befuxl2y.js";import{n as a,t as f}from"./property.SQfKehJm.js";import{n as d}from"./query-assigned-nodes.DReJme1H.js";import{e as m,n as u}from"./ref.CRcBsAhM.js";import"./base.CShCMygk.js";import"./directive-helpers.Do8-cIhX.js";import"./directive.C_Rw-dL6.js";var v=Object.defineProperty,y=Object.getOwnPropertyDescriptor,i=(t,e,l,s)=>{for(var r=s>1?void 0:s?y(e,l):e,p=t.length-1,n;p>=0;p--)(n=t[p])&&(r=(s?n(e,l,r):n(r))||r);return s&&r&&v(e,l,r),r};let o=class extends g{constructor(){super(),this.dialogPopover="auto",this.dialogStyle="",this.closetarget="[slot=dropdown]",this.closesoon=!1,this.dialogRef=m(),this._will_close=!1,this._id=crypto.getRandomValues(new Uint32Array(1))[0].toString()}get dialog(){return this.dialogRef.value}toggle(){const t=this.dialog;t&&t.togglePopover()}async handleBeforeClose(t){if(this._will_close)return;const e=this.dialog,l=t.target;e&&l&&l.closest(this.closetarget)&&(this._will_close=!0,setTimeout(()=>{e.hidePopover(),this._will_close=!1},this.closesoon?0:600))}render(){return c`<div class="na-popover-wrapper">
    ...
    `;i([a({attribute:"dialog-popover",type:String})],o.prototype,"dialogPopover",2);i([a({attribute:"dialog-style",type:String})],o.prototype,"dialogStyle",2);i([a({attribute:"closetarget",type:String})],o.prototype,"closetarget",2);i([a({attribute:"closesoon",type:String})],o.prototype,"closesoon",2);i([d()],o.prototype,"defaultSlotNodes",2);i([d({slot:"dropdown",flatten:!0})],o.prototype,"dropdownSlotNodes",2);o=i([f("na-dropdown")],o);export{o as Dropdown};
